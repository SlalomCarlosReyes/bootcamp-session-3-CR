    ...
    >
      ...
      <Box component="form" onSubmit={handleSubmit} display="flex" flexDirection="column" gap={1.5}>
        ...
        <FormControl fullWidth size="small">
          ...
          <Select
            ...
            sx={{
              ...
              '& .MuiOutlinedInput-notchedOutline': {
                borderColor: priority === 'P1' ? '#f44336' : priority === 'P2' ? '#ff9800' : '#9e9e9e',
              },
          ...
          >
            <MenuItem value="P1" sx={{ color: '#f44336', fontWeight: 600 }}>P1 — High</MenuItem>
            <MenuItem value="P2" sx={{ color: '#ff9800', fontWeight: 600 }}>P2 — Medium</MenuItem>
            <MenuItem value="P3" sx={{ color: '#9e9e9e', fontWeight: 600 }}>P3 — Low</MenuItem>
          </Select>
        </FormControl>
